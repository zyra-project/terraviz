...
- **Module organization**: services in `src/services/`, UI controllers in
  ...
  should fit this layout. When you add a module, add a one-line row to the
  matching module map in the same PR — [CLAUDE.md](CLAUDE.md) for `src/` and
  `src-tauri/src/`, [docs/BACKEND_MODULES.md](docs/BACKEND_MODULES.md) for
