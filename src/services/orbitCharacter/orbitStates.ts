...
export const STATES: Record<StateKey, StateConfig> = {
  ...
  THINKING:   { label: 'Thinking',   orbitSpeed: 0.2,  orbitRadiusScale: 0.70, pupilSize: 0.80, pupilBrightness: 0.80, pupilPulse: false, pupilJitter: 0.03, upperLid: 0.20, lowerLid: 0.05, subMode: 'cluster',   trail: 0.00, head: 'tilt',  blinkInterval: 3.0, blinkDuration: 0.16 },
  ...
  HAPPY:      { label: 'Happy',      orbitSpeed: 0.9,  orbitRadiusScale: 1.05, pupilSize: 1.10, pupilBrightness: 1.10, pupilPulse: false, pupilJitter: 0.00, upperLid: 0.06, lowerLid: 0.34, subMode: 'orbit',     trail: 0.35, head: 'none',  blinkInterval: 2.5, blinkDuration: 0.14 },
  ...
  SLEEPY:     { label: 'Sleepy',     orbitSpeed: 0.15, orbitRadiusScale: 0.80, pupilSize: 0.70, pupilBrightness: 0.45, pupilPulse: false, pupilJitter: 0.00, upperLid: 0.40, lowerLid: 0.34, subMode: 'cluster',   trail: 0.00, head: 'none',  blinkInterval: 1.5, blinkDuration: 0.38 },
